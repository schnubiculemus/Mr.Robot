...
Läuft im Heartbeat, nicht im Gespräch. Holt neue Turns aus der Datenbank, teilt sie in Blöcke (max 20 Turns), lädt bestehende Chunks als Kontext und lässt gpt-oss:120b analysieren. Ergebnis: create, confirm, update oder supersede.nfirm, update oder supersede.nfirm, update oder supersede.nfirm, update oder supersede.nfirm, update oder supersede.nfirm, update oder supersede. Max 10 Aktionen pro Block, Decisions dürfen das Limit überschreiten.
